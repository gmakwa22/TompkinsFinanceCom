...
//    View::share('corplogo', 'images/megacashbucks.png');
  ...
  View::share('privname', 'Sage Endeavours, LLC');
  View::share('privoff', 'Kevin Schmelzle MB');
  View::share('privurl', 'https://www.sageendeavours.com/');
  ...
  View::share('privemail', 'privacy@sageendeavours.com');
  View::share('suportemail', 'support@sageendeavours.com');
