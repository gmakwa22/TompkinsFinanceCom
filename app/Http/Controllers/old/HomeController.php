...
class HomeController extends Controller
{
    ...
    public function surrey()
    {
        ...
        SEOMeta::setTitle('{{ $privname }} | Need Instant Payday Loans in Surrey BC Online? Get Up To $5000 From a Safe Trusted Licensed Lender. Easy Application. Multiple repayments, 5 Minutes‎‎ e-Transfer.');
    ...
    public function thompson()
    {
        ...
        SEOMeta::setTitle(' Need Instant Payday Loans Online in Thompson, MB? Get Up To $5000 with {{ $privname }}. Easy Application. Multiple repayments, 5 Minutes‎‎ e-Transfer.');
    ...
    public function brandon()
    {
        ...
        SEOMeta::setTitle('{{ $privname }} | Need Instant Payday Loans Online in Brandon, MB? Get Up To $5000 From a Safe Trusted Licensed Lender. Easy Application. Multiple repayments, 5 Minutes‎‎ e-Transfer.');
    ...
    public function winkler()
    {
        ...
        SEOMeta::setTitle('{{ $privname }} | Need Instant Payday Loans Online in Winkler MB? {{ $privname }} a Safe Trusted Licensed Lender. Easy Application. Multiple repayments, 5 Minutes‎‎ e-Transfer.');
    ...
    public function Education()
    {
        ...
        SEOMeta::setDescription('Why Us? {{ $privname }} offers trusted, fast and flexible short term loans to Canadians. Our loans for bad credit in many repayments will put your finances back on track! Come & view our Education Center to learn more.');
        SEOMeta::addKeyword('{{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function Faq()
    {
        ...
        SEOMeta::setDescription('Frequently Asked Questions (FAQ) {{ $privname }} offers trusted, fast and flexible short term loans to Canadians. Our loans for bad credit in many repayments will put your finances back on track!');
        SEOMeta::addKeyword('{{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function Privacy()
    {
        ...
        SEOMeta::setDescription('Learn how {{ $privname }}, a safe and trusted direct lender safeguards your private information with our privacy policy, what data we collect and how we use this data in the loan application process.');
        SEOMeta::addKeyword('{{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function emergency_loans()
    {
        ...
        SEOMeta::setDescription('Disability Loans, Short Term Loans Or Cash Advance Loan Interest Rates & How They Work? Contact {{ $privname }}. The Most Trusted Payday Advance In Canada for emergency loans.');
        SEOMeta::addKeyword('Payday Advance, {{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function why_choose_us()
    {
        ...
        SEOMeta::setDescription('Why Choose Us? {{ $privname }} is a financial institution providing low cost quick online payday loans and fast cash advances in multiple repayments. Easy to apply and instant approval! Money by e-transfer all over Canada.');
        SEOMeta::addKeyword('{{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function payday_loans_near_me()
    {
        ...
        SEOMeta::setDescription('Payday adva Loans Near Me, Short Term Loans Or Cash Advance Loan Interest Rates  How They Work? Contact {{ $privname }}. The Only Trusted Payday Advance In Canada.');
        SEOMeta::addKeyword('Payday Advance, {{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
    ...
    public function same_day_payday_loans()
    {
        ...
        SEOMeta::setDescription('Same Day Payday Loans, Short Term Loans Or Cash Advance Loan Interest Rates & How They Work? Contact {{ $privname }}. The Only Trusted Payday Advance In Canada.d');
        SEOMeta::addKeyword('Payday Advance, {{ $privname }}, online cash loans, money, cash, cash canada, fast cash, cash loans, quick cash, Wise loans, payday, alberta, ontario, british columbia, nova scotia, Saskatchewan, Manitoba, financial, cash lenders, canada, canadian, online cash loan, loans, Wise loan, cash loan,  payday, payday loans, payday loan, express approval, easy money, easy cash, cash advance, toronto, ottawa, vancouver, edmonton, calgary, bc, new brunswick, moncton');
