...
<!-- Modern Hero Section -->
<section class="page-section-ptb theme-bg pgs-background custom-bg-image" style="background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); position: relative; overflow: hidden;">
  <div class="container">
