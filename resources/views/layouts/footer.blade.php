...
<b>Get started today for even better service!</b><br>
				...
				<div class="modal-body">
					...
					<div class="container-fluid license scrollbar">
						<div class="col-xs-12">
							...
							<!-- <h5>PayDay is a direct lender, licensed for lending in Texas</h5>
							<p>PayDay makes responsible short term loans, fully compliant in all American states. <b>Our business is transparent and guided by state consumer protection laws. </b></p>
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="container-fluid license scrollbar">
						<div class="col-xs-12">
							<div class="title">
								<!-- <h5>PayDay is a direct lender, licensed for lending in Missouri</h5> -->
								<h5>State of Missouri License will be here soon!</h5>
...
<div tabindex="-1" class="modal fade modal-prov" id="newfoundland-and-labrador-dialog-modal" role="dialog" style="display: none;">
    ...
    <script type="text/javascript">
    	jQuery("#paycheck").datepicker({
		    minDate: 0,
		    showOn: "button",
		      buttonImage: "http://www.megacashbucks.com/public/images/calendar-icon.jpg",
