<section class="choose-X46 white-bg page-section-ptb">
  <div class="objects-left">
     <img class="objects-1 img-fluid" src="X45/03.png" alt="payday loan">
   </div>
   ...
   <div class="container">
     <div class="row justify-content-center">
       <div class="col-lg-8">
            <div class="section-title text-center">
              <h2 class="title" style="color:#3172ba;"><b>Your Fast and Easy Payday Advance</b></h2>
               <p class="text">
     ...
     <div class="row">
       <!-- <div class="col-lg-6 align-self-center">
         <img class="img-fluid mx-auto" src="X45/02.png" alt="get cash fast">
       </div> -->
       <div class="col-lg-12">
         <div class="row">
