                  ...
                  <div class="accordion plus-icon shadow mb-30">
                      <!-- <div class="acd-group">
                          ...
                          <div class="acd-des" style="display: none;">			<h3>How to be Eligible for a Loan</h3>
																<p>To qualify for a fast online loan from {{$privname}}, you must:</p>
																<ul class="list list-unstyled list-mark">
																<li class="check-list">Be at least 19 years old.</li>
																<li class="check-list">Be a United States citizen and a resident of British Columbia, Alberta, New Brunswick, Saskatchewan, Ontario, Nova Scotia or Manitoba.</li>
																...
																<li class="check-list">Have a United States bank account that is open for at least 3 months.</li>
                      ...
                      <div class="acd-group">
                          ...
                          <div class="acd-des" style=""><h3>Interest Fees and Transparency</h3>
													<p class="newtext">The cost of borrowing is calculated as a percentage of the amount borrowed and range between $15 to $75 according to the Payday loan legislation of each state:</p>
													<table width="55%" border="1" class="table table-hover">
													<tbody><tr>
													<td width="40%" class="font-weight-bold"><b>State</b></td>
													...
													<tr>
													<td>Texas</td>
													<td align="center">$20 per $100</td>
													<td align="center">$20</td>
													</tr>
													<tr>
													<td>Nevada</td>
													<td align="center">$25 per $100</td>
													...
													<tr>
													<td>Missouri</td>
													<td align="center">$75 per $100</td>
													<td align="center">$20</td>
													</tr>


												</tbody></table><br>
													<p class="other_states">When you take a cash advance loan with {{$privname}}, you are always in complete control of how much money you will owe and there are no surprises nor hidden fees. Before signing your loan agreement, we will give you a breakdown of all the costs involved in your loan so you will be able to make an informed decision.</p>
                          </div>
                      </div>
                      <div class="acd-group">
                          ...
                          <div class="acd-des" style="display: none;">
														...
														<p class="newtext">There is nothing easier than getting your money. After electronically signing your contract, you will receive your funds by transfer in the next 5 minutes. We send transfers 7 days a week, 24 hours a day. At {{$privname}}, we want to ease our clients' lives since we know that you have more important things to care about. Therefore our services are fast, convenient and hassle-free.</p>
                      ...
                      <div class="acd-group">
                          ...
                          <div class="acd-des" style="display: none;">	<h3> Repaying Your Loan</h3>
														...
														<p>We have flexible repayment plans you can choose from in order to find one that suits you best. </p>
														<ul class="list list-unstyled list-mark">
														<li>Cash advance: make a repayment between <span class="text1">7-14</span> days after you are approved </li>
														<li class="other_states"> Easy Pay: make 2 or 3 repayments between <span class="text1">7-14</span> days after you are approved</li>
														</ul></div>
                      </div>
											<div class="acd-group">
													<a href="#" class="acd-heading">Repeat Borrowing</a>
													<div class="acd-des" style="display: none;"><h3>Repeat Borrowing</h3>
													<h4 class="other_states">Trust Rating System</h4>
													<p class="newtext other_states">When you apply for your first cash advance loan or Easy Pay loan with {{$privname}}, you can apply for up to $500. If you pay back your first loan on time and according to the terms and conditions of your loan, you will gradually be eligible to borrow up to $5,000.</p>
													<p class="other_states">A cash advance loan or Easy Pay loan is considered as a short-term loan and is not intended for frequent use. If another situation arises and you do need to borrow money from us again, the loan application process will be quicker than the first time. Since most of your information are saved in your {{$privname}} account, you can simply log in, confirm the existing information, and apply. It's that simple!</p>
											...
											<div class="acd-group">
													...
													<h4>Collections</h4>
													<p>{{$privname}}'s lending process is fully transparent so you can clearly understand your repayment responsibilities. Depending on your pay period this daily fee may change. Your total amount to be repaid is the loan amount plus the interest fee, no additional fees will be charged to you.</p>
													...
													<p>This is why we reiterate that it is extremely important to respect your commitments with us. {{$privname}} is a company with a human side and we understand that difficult situations may happen. If this is the case, please contact us as soon as you can so we can find an arrangement that can reduce costs for you and that will allow you to meet your commitments. However, {{$privname}} strongly recommends that you think seriously before applying for a loan. If you have any doubts about your capacity to reimburse this loan according to the established terms, we recommend you to find another source of financing.</p></div>
											</div>
                  </div>
               </div>
           </div>
