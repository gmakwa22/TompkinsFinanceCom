...
<section class="marketing-service page-section-ptb">
		<div class="container">
			<div class="col-xs-12">
				...
				<h2 class="small-title">Get Up To $5,000. Low Rates. 5 Minutes transfers.</h2>
      	<p class="text text-justify">When you need same day loans, you can't afford to wait for your money. As a company, {{ $privname }} is focused on helping Americans handle financial emergencies.</p>
      	<p class="text text-justify">We are a direct online American lender that offers same day loans online. There are no collateral requirements, no office visits and no document requirements from the loan application process.</p>
      	...
      	<p class="text text-justify">Same day loans online is all we do at {{ $privname }}. In fact, we are revolutionizing the way Americans think about unsecured loans and provide access to credit that is customer-focused, easy-to-use, and exceptionally fast.</p>
      	<p class="text text-justify">We offer competitive interest rates, customer service that’s based on America and is bilingual in both official languages and we have a Cashback rewards program. You can apply for a <a href="{{url('/payday-advance')}}" rel="noopener">payday advance</a> loan of up to $5,000 and get pre-approved in as little as 10 minutes.</p>
      	...
      	<p class="text text-justify">Ordinarily, with traditional lenders and banks, applying for a loan and getting approved on the same day is unheard of. There are payday lenders who sometimes offer fast loans in brick-and-mortar stores, but those, too, can be a bit hard to get as they require a ton of paperwork, and have other requirements. What's more, some companies will only approve you for small loans, and then you'll need to deposit a check into your bank account. The online approach from {{ $privname }} is much safer, more faster, and more convenient for the vast majority of Americans as they can apply for a loan from their home or work via the {{ $privname }} website.</p>
...
<section class="marketing-service page-section-ptb">
		<div class="container">
			<div class="col-xs-12">
<h2 class="display-4">Same Day Cash Loans in America</h2><br>
</div>
<h3 class="small-title" style="color:#3172ba;">
Same Day Cash Loans for Unexpected Emergency Bills
</h3>
<p class="text text-justify">
One of the most common reasons for Americans to get same day cash loans is to cover unexpected bills or emergency expenses. These types of costs always seem to come up at the worst possible time.
For Americans who are living paycheck-to-paycheck, or don’t have a great deal of savings, these kinds of expenses can be devastating to the finances and budget of a household.
But with an <a href="{{url('/emergency-loans')}}" rel="noopener">emergency loan</a> from America's premiere direct online lender, {{ $privname }}, you can pay all your bills quickly and get on with your life!
</p>
<h3 class="small-title" style="color:#3172ba;">
Same Day Cash Advance for Medical, Dental, or Childcare Bills
</h3>
<p class="text m-bottom">
We are fortunate in America to have a great health care system however some medical bills such as dental costs aren’t covered.
...
<p class="text m-bottom">
We recognize that not everyone has perfect credit. No reputable American lender can offer instant cash loans with no credit check. But, quality lenders like {{ $privname }} can promise that your credit history will NOT cause your loan application to be rejected.
We approve 9 out of 10 applications and are the number 1 lender for Americans who have bad credit and need same day cash loans.
That's why many customers with who have not so perfect credit are able to get a <a href="{{url('/bad-credit-loans')}}" rel="noopener">bad credit loan</a> with {{ $privname }} on the same day that they apply for a loan.
...
Don't put off needed repairs, purchases, or projects indefinitely, hoping you can save up the cash you need. Instead, <a href="{{url('/borrow-money')}}" rel="noopener">borrow money</a> from {{ $privname }} and get approved the same day and pay back your loan with multiple payments.
</p>
<h3 class="small-title" style="color:#3172ba;">
