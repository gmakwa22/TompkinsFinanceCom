<div id="phone" class="col-xs-12 col-sm-5 alpha omega f-right">
        ...
        <div class="choice-missouri" >
        <div class='col-xs-12 details'>
        In Missouri, only a single repayment option is available. A loan taken out with us in Missouri must be fully repaid at the next pay date.
        </div>
        </div>
        <div class="clearfix"></div>
        <h3 class="sub3">Tell us what state you live in.</h3>
        ...
        <option id="nevada" data-loan-selected-state="false" data-loan-percent="17" value="nevada">Nevada</option>
        <option id="missouri" data-loan-selected-state="false" data-loan-percent="15" value="missouri">Missouri</option>
        <option id="california" data-loan-selected-state="false" data-loan-percent="15" value="california">California</option>
