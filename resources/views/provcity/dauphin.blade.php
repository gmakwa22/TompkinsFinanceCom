<section class="marketing-service page-section-ptb">
		<div class="container">
			<div class="col-xs-12">
				...
				<p class="text text-justify">So, if you're looking for a short-term loan, with a trusted, direct lender, <a href="/">{{$privname}}</a> is the company for you. Our Code of Conduct is drawn from industry best practices, ensuring a transparent and responsible lending process wherever you are, in Dauphin or across Alberta.</p>
